...
extension ChatIntroInteractiveViewController: ChatTableViewTouchDelegate {
    ...
    func tappedIndexPath(_ indexPath: IndexPath, tableView: UITableView, touch: UITouch) {
        ...
        if tableView == rootView.choiceTableView {
            ...
            if let preloadedResponseChatObject = source?.chat as? PreloadedResponseChatObject {
                ...
                let responseChatTableViewCellSource = ChatTableViewCellSourceMaker.makeChatTableViewCellSource(fromChatObject: responseChatObject)
