...
class EssayViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.delegate = sourcedTableViewManager
        tableView.dataSource = sourcedTableViewManager
        
        /* Setup EssayCell Nibs */
        RegistryHelper.register(Registry.View.TableView.Essay.Cells.body, to: tableView)
        RegistryHelper.register(Registry.View.TableView.Essay.Cells.entry, to: tableView)
        RegistryHelper.register(Registry.View.TableView.Essay.Cells.loading, to: tableView)
        RegistryHelper.register(Registry.View.TableView.Essay.Cells.premium, to: tableView)
        RegistryHelper.register(Registry.View.TableView.Essay.Cells.prompt, to: tableView)
