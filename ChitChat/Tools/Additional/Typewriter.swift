...
class Typewriter: Any {
    ...
    var updateBlock: (Typewriter, String)->Void = { typewriter, completedText in }
    
    @discardableResult
    static func start(text: String, timeInterval: Double, typingUpdateLetterCount: Int, block: @escaping (Typewriter, String)->Void) -> Typewriter {
        let typewriter = Typewriter(toTypeString: text, timeInterval: timeInterval, typingUpdateLetterCount: typingUpdateLetterCount)
        typewriter.resume()
