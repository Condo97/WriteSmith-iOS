...
struct IntroInteractivePresentationSpecification: StackedPresentationSpecification {
    
    let stackedViewControllers: [StackedViewController]
    
    let storiesViewController: ChatIntroInteractiveViewController = ChatIntroInteractiveViewController.Builder()
        .set(rootViewNibName: Registry.IntroInteractive.View.chat)
    ...
    let essaysAsChatViewController: ChatIntroInteractiveViewController = ChatIntroInteractiveViewController.Builder()
        .set(rootViewNibName: Registry.IntroInteractive.View.chat)
        .add(headerLabelSource: LabelTableViewCellSource(
            text: "Write",
            font: UIFont(name: Constants.primaryFontNameBlack, size: 90.0)!,
