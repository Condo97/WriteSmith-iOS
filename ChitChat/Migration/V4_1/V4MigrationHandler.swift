...
//        }
        ...
        for conversation in conversations {
            ...
            let (latestChatDate, latestChatText) = try await getLatestChatTextAndDateInConversation(conversationManagedObjectID: conversation.objectID)
    ...
    private static func getLatestChatTextAndDateInConversation(conversationManagedObjectID: NSManagedObjectID) async throws -> (Date?, String?) {
